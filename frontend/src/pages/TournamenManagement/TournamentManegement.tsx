...
export const TournamentManegement = () => {
  ...
  const [photocellStartSeeker, setPhotocellStartSeeker] =
  ...
  useQuery(
    ...
    async () => (await apiClient.get("photoCell")).data,
    {
      onSuccess: (res: string) => {
        ...
        const pageFields = Array.from(html.querySelectorAll("p")).map(
          (z) => z.textContent
        );
          ...
          <div className="col-4">
            ...
            <div className="currentRideContainer">
              <div className="currentRide d-flex flex-column">
                <label htmlFor="player" className="fs-6 m-1">
                  Imię i nazwisko
                </label>
                <input
                  id="player"
                  ...
                  value={
                    activeQueueData?.player.name +
                    " " +
                    activeQueueData?.player.surname
                  }
                />
                <label htmlFor="school" className="fs-6 m-1">
                  Szkoła
                </label>
                <input
                  id="school"
                  ...
                  disabled
                  className="form-control fs-6"
                  value={activeQueueData?.player.school.acronym}
                />
                <label htmlFor="gokart" className="fs-6 m-1">
                  Gokart
                </label>
                <input
                  id="gokart"
                  ...
                  disabled
                  className="form-control fs-6"
                  value={activeQueueData?.gokart.name}
                />
              </div>
              <div className="d-flex flex-column align-items-center py-2">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    placeholder="min"
                    value={convertTimeFromMilisecondsToObject(time)
                      .m.toString()
                      .padStart(2, "0")}
                  />
                  :
